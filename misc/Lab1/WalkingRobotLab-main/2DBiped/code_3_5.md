...
*Editing using markdown. Difficult to keep part of code red. So another style is taken to illustrate.*
...
```
<font color=red>modification here</font>
```python
        self.motion_f = 5 # Controlled motion frequency, Hz
```
<font color=red>modification finish</font>
```
...
**To better copy the code, here is the the code**
